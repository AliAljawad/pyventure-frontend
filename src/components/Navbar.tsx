...
import { Menu, X, User, Award, Terminal, Home } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:ml-6 md:flex md:items-center md:space-x-4">
            <Button variant="ghost" className="text-gray-200 hover:text-white" onClick={() => navigateTo("/")}>
              <Home className="w-4 h-4 mr-2" />
              Home
            </Button>
            <Button variant="ghost" className="text-gray-200 hover:text-white" onClick={() => navigateTo("/leaderboard")}>
              <Award className="w-4 h-4 mr-2" />
              Leaderboard
            </Button>
            <Button variant="ghost" className="text-gray-200 hover:text-white" onClick={() => navigateTo("/playground")}>
              <Terminal className="w-4 h-4 mr-2" />
              Playground
            </Button>
            <Button variant="ghost" className="text-gray-200 hover:text-white" onClick={() => navigateTo("/profile")}>
              <User className="w-4 h-4 mr-2" />
              Profile
            </Button>
            <Button className="ml-4 cosmic-button" onClick={() => navigateTo("/login")}>
              <User className="w-4 h-4 mr-2" />
              Login
            </Button>
          </div>
